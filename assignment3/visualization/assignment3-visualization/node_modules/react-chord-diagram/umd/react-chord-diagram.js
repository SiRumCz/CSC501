...
/* harmony default export */ var src_chord = (function() {
  ...
  function chord(matrix) {
    ...
    k = src_math_max(0, src_math_tau - padAngle * n) / k;
...
function band() {
  ...
  function rescale() {
    ...
    var values = d3_array_src_range(n).map(function(i) { return start + step * i; });
...
function quantile_quantile(values, p, valueof) {
  return quantileSorted(Float64Array.from(number_numbers(values, valueof)).sort(d3_array_src_ascending), p);
}

function quantileSorted(values, p, valueof = d3_array_src_number) {
  if (!(n = values.length)) return;
  if ((p = +p) <= 0 || n < 2) return +valueof(values[0], 0, values);
  if (p >= 1) return +valueof(values[n - 1], n - 1, values);
  var n,
...
function src_quantile_quantile() {
  ...
  scale.domain = function(_) {
    ...
    domain.sort(d3_array_src_ascending);
    return rescale();
  };
  ...
  function tickInterval(interval, start, stop) {
    ...
    if (typeof interval === "number") {
      var target = Math.abs(stop - start) / interval,
          i = src_bisector(function(i) { return i[2]; }).right(tickIntervals, target),
          step;
...
function sequentialQuantile() {
  ...
  function scale(x) {
    if (!isNaN(x = +x)) return interpolator((src_bisect(domain, x) - 1) / (domain.length - 1));
  }
...
/* harmony default export */ var d3_array_src_descending = (function(a, b) {
  return b < a ? -1 : b > a ? 1 : b >= a ? 0 : NaN;
});
...
var Svg_Svg = function Svg(_ref) {
    ...
    return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
        'div',
        { className: 'svg-container', style: _extends({}, style, !resizeWithWindow ? { width: width + 'px', height: height + 'px' } : {}) },
            ...
            return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
                'g',
                {
                    ...
                    onClick: function onClick() {
                        setHoverPersist(!hoverPersist);_onClick(group.index);
                    }
                },
                external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement('path', {
                    ...
                    stroke: '' + color_rgb(color(groupIndex)).darker(), d: arc(group)
                }),
                external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
                    'text',
                    {
...
var Ribbons_Ribbons = function Ribbons(_ref) {
    ...
    return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
        ...
        chords.map(function (chord, chordIndex) {
            ...
            var style = blurOnHover ? { fillOpacity: '' + (hidden ? ribbonBlurOpacity : ribbonOpacity) } : { display: '' + (hidden ? 'none' : 'block'), fillOpacity: ribbonOpacity };

            return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement('path', {
                key: chordIndex,
                style: style,
                fill: color(chord.target.index),
                stroke: '' + color_rgb(color(chord.target.index)).darker(),
                strokeWidth: strokeWidth,
                d: '' + ribbon({ source: chord.source, target: chord.target }),
                onClick: function onClick() {
                    setHoverPersist(!hoverPersist);_onClick(chordIndex);
                },
                onMouseOver: !disableHover && !hoverPersist ? function () {
...
var ChordDiagram_ChordDiagram = (_temp = _class = function (_Component) {
    ...
    function ChordDiagram(props) {
        ...
        _this.setHoverPersist = _this.setHoverPersist.bind(_this);
        _this.setMouseOverGroup = _this.setMouseOverGroup.bind(_this);
        _this.setMouseOverRibbon = _this.setMouseOverRibbon.bind(_this);
        return _this;
    }

    ChordDiagram.prototype.clearHover = function clearHover() {
        this.setState({ hoverPersist: false, mouseOverGroup: null, mouseOverRibbon: null });
    };

    ChordDiagram.prototype.setHoverPersist = function setHoverPersist(hoverPersist) {
        if (this.props.persistHoverOnClick) {
            this.setState({ hoverPersist: hoverPersist });
        }
    };
    ...
    ChordDiagram.prototype.setMouseOverRibbon = function setMouseOverRibbon(mouseOverRibbon) {
        this.setState({ mouseOverRibbon: mouseOverRibbon });
    };
    ...
    ChordDiagram.prototype.render = function render() {
        var _props = this.props,
            ...
            groupOnClick = _props.groupOnClick,
            ...
            disableGroupHover = _props.disableGroupHover,
            disableRibbonHover = _props.disableRibbonHover,
            strokeWidth = _props.strokeWidth,
            resizeWithWindow = _props.resizeWithWindow,
            ribbonOnClick = _props.ribbonOnClick,
            blurOnHover = _props.blurOnHover,
            ribbonOpacity = _props.ribbonOpacity,
            ribbonBlurOpacity = _props.ribbonBlurOpacity,
            persistHoverOnClick = _props.persistHoverOnClick,
            svgOnClick = _props.svgOnClick;
        ...
        var color = ordinal().domain(d3_array_src_range(groupColors.length)).range(groupColors);
        ...
        return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
            ...
            external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(src_Groups, {
            ...
            external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(src_Ribbons, {
                chords: chords,
                color: color,
    ...
    return ChordDiagram;
}(external_root_React_commonjs2_react_commonjs_react_amd_react_["Component"]), _class.propTypes = {
    ...
    padAngle: 0.05,
    sortGroups: null,
    sortSubgroups: d3_array_src_descending,
    sortChords: null,
    labelColors: ['#000000'],
    disableHover: false,
...
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "default", function() { return ChordDiagram_ChordDiagram; });
